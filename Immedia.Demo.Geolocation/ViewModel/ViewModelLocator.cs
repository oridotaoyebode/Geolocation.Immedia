...
using Immedia.Demo.Geolocation.Design;
...
namespace Immedia.Demo.Geolocation.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public const string FullScreenPageKey = "FullScreenPage";
        ...
        static ViewModelLocator()
        {
                ...
                && !UseDesignTimeData)
            {
                ...
                SimpleIoc.Default.Register<IGooglePlaceService, GooglePlaceService>();
            }
            else
            {
            ...
            SimpleIoc.Default.Register<PlaceDetailsViewModel>();
        }
